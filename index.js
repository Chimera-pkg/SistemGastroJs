const questions = [
  ...
  { pertanyaan: "2. Apakah anda mengalami berak encer?" },
  { pertanyaan: "3. Apakah anda mengalami berak berdarah?" },
  { pertanyaan: "4. Apakah anda merasa lesu dan tidak bergairah?" },
  { pertanyaan: "5. Apakah anda tidak selera makan?" },
  {
    pertanyaan:
      "6. Apakah anda merasa mual dan sering muntah (lebih dari 1 kali)?",
  },
  { pertanyaan: "7. Apakah anda merasa sakit di bagian perut?" },
  { pertanyaan: "8. Apakah tekanan darah anda rendah?" },
  { pertanyaan: "9. Apakah anda merasa pusing?" },
  { pertanyaan: "10. Apakah anda mengalami pingsan?" },
  { pertanyaan: "11. Apakah suhu badan anda tinggi?" },
  { pertanyaan: "12. Apakah anda mengalami luka di bagian tertentu?" },
  {
    pertanyaan:
      "13. Apakah anda tidak dapat menggerakkan anggota badan tertentu?",
  },
  { pertanyaan: "14. Apakah anda pernah memakan sesuatu?" },
  { pertanyaan: "15. Apakah anda memakan daging?" },
  { pertanyaan: "16. Apakah anda memakan jamur?" },
  { pertanyaan: "17. Apakah anda memakan makanan kaleng?" },
  { pertanyaan: "18. Apakah anda membeli susu?" },
  { pertanyaan: "19. Apakah anda meminum susu?" },
];
...
questions.forEach((item) => {
  ...
  <div class="form-check">
    <input
      class="form-check-input pertanyaan-check"
      type="checkbox"
...
$("button").click(function () {
  var checked = [];
  $.each($("input.pertanyaan-check:checked"), function () {
